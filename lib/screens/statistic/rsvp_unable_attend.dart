...
class RsvpUnableAttend extends StatefulWidget {
  final String idServer;
  final String sessionId;
  final int totalkey;
  final String rsvpKey = '0';
...
class _RsvpAttendScreenState extends State<RsvpUnableAttend> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color.fromARGB(255, 210, 71, 117),
        foregroundColor: Color.fromARGB(255, 250, 202, 139),
        title: Text('RSVP Unable Attend (${widget.totalkey})'),
      ),
